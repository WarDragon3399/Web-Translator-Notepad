...
3. Look at the Address Bar (URL bar) on the far right.
4. You will see a small icon that looks like three squares and a plus sign ⊕ or a computer with an arrow 🖥️.
5. Click it and select Install.
Result: The notepad will now appear in your Start Menu/Applications folder and open in its own window without the browser search bar.

🤖 Android (Samsung, Pixel, etc.)
1. On Chrome or Edge Mobile:
2. Open the site in your mobile browser.
3. Tap the three dots (⋮) in the top right or bottom corner.
4. Scroll down and tap "Install app" or "Add to Home screen".
5. Confirm the installation.
Result: Your icon will appear on your home screen just like a real app from the Play Store.
...
Result: It will appear on your iPhone home screen. Note: Since iOS 17/18, you can also do this from Chrome for iOS using the Share menu.
